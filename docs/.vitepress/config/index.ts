    ...
    sidebar: {
      ...
      '/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'PINIA_COLADA_C0001', link: '/errors/pinia_colada_c0001.html' },
            { text: 'PINIA_COLADA_R0001', link: '/errors/pinia_colada_r0001.html' },
            { text: 'PINIA_COLADA_R0002', link: '/errors/pinia_colada_r0002.html' },
            { text: 'PINIA_COLADA_R0003', link: '/errors/pinia_colada_r0003.html' },
            { text: 'PINIA_COLADA_R0004', link: '/errors/pinia_colada_r0004.html' },
            { text: 'PINIA_COLADA_R0005', link: '/errors/pinia_colada_r0005.html' },
            { text: 'PINIA_COLADA_R0006', link: '/errors/pinia_colada_r0006.html' },
            { text: 'PINIA_COLADA_R0007', link: '/errors/pinia_colada_r0007.html' },
            { text: 'PINIA_COLADA_R0008', link: '/errors/pinia_colada_r0008.html' },
            { text: 'PINIA_COLADA_R0009', link: '/errors/pinia_colada_r0009.html' },
          ],
        },
        {
          text: 'Cookbook',
          ...
          items: [
            ...
            { text: 'Testing', link: '/cookbook/testing.html' },
            ...
            { text: 'Devtools v2 Migration', link: '/cookbook/migration-devtools-v2.html' },
          ],
        },
      ],
    },
