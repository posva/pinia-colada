...
This plugin is implemented using the same plugin mechanism described in [Plugins](../advanced/plugins.md) (it listens to the query cache `fetch` action via `$onAction()`).
