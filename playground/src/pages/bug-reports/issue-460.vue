...
function prefetch() {
  queryCache.refresh(queryCache.ensure({
    key: ['issue-460'],
    query: async () => 'ok',
...
<template>
  <main class="max-w-3xl mx-auto p-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-4">
      Prefetched Query GC Display
    </h1>
    
    <p class="text-gray-600 mb-8">
      When a query is prefetched without any active observers, DevTools should display the correct garbage collection timing instead of showing an incorrect timestamp like "56 years ago".
    </p>
    ...
    <section class="bg-gray-50 rounded-lg p-6 mb-6">
      ...
      <ol class="list-decimal list-inside space-y-2 text-gray-700">
        ...
        <li>Find the query with key <code class="px-1.5 py-0.5 bg-gray-200 rounded text-sm font-mono">["issue-460"]</code> in DevTools</li>
